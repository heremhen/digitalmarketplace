...
urlpatterns = [
    ...
    path('manage-shipping', views.manage_shipping, name='manage-shipping'), # Manage shipping url
    path('track-orders', views.track_orders, name='track-orders'),  # Track orders url
]